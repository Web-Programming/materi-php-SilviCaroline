...
3. Jalankan perintah 'composer install' untuk mendownload depedensi 
4. Copy file '.env.example' dan rename menjar '.env'
...
## Menjalankan server 
1. Pastikan seluruh depedensi telah terinstall 
